...
```
The visualization shows at what prince range's apartments in the data-set are located in.
...
ggplot(czyste, aes(x = city, y = price)) +  
  ...
  theme_minimal() +  
  labs(title = "Price Distribution by City", x = NULL, y = "Price") +   miast
