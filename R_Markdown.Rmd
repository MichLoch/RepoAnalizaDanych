...
Most of the Polish apartaments at 77,1% are at the price range from 250.000 to 1.000.000 PLN
The price distribution is highly right-skewed, indicating a large number of high-priced apartments.
Over 13% of properties exceed 1,250,000 PLN, confirming the presence of high-endreal estate.

##### City where the apatament is located is the most significant factor for it's price
Boxplots show significant price variability between cities.
...
The dataset may be skewed by high-end suburban developments rather than traditional urban apartments.
