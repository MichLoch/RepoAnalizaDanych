...
Visualizing the missing data using Heat-map
...
```{r}
# Compute basic descriptive statistics for price
price_stats <- czyste %>%
  summarise(
...
# Format the statistics into a nice table
price_stats %>%
  kable(format = "markdown", caption = "Descriptive Statistics for Price") %>%
